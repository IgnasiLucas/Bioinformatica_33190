...
## ENA. Contenidos
![](data_tiers_diagram.png){width=800px}

## ENA. Estadísticas {.columns-2}
<div class="float: left; width: 50%;">
![](ena_embl_growth.png){width=400px}
</div>

<div class="float: right; width: 50%;">
![](ena_embl_doubling.png){width=400px}
</div>

## ENA. Estadísticas {.columns-2}
<div class="float: left; width: 50%;">
![](ena_sra_growth.png){width=400px}
</div>

<div class="float: right; width: 50%;">
![](ena_sra_doubling.png){width=400px}
</div>
